...
const etc = React.lazy(() => import('./views/Map/etc'))
const Hospital = React.lazy(() => import('./views/Map/Hospital'))
const Restaurant = React.lazy(() => import('./views/Map/Restaurant'))
const AvailableJobs = React.lazy(() => import('./views/AvailableJobs'))
...
const routes = [
  ...
  { path: '/Map', name: 'Map', component: etc, exact: true },
  { path: '/Map/etc', name: 'etc', component: etc },
  { path: '/Map/Hospital', name: 'Hospital', component: Hospital },
  { path: '/Map/Restaurant', name: 'Restaurant', component: Restaurant },
  { path: '/Available-jobs', name: 'Available Jobs', component: AvailableJobs },
]
